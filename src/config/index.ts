...
export default {
  ...
  cors_origins: process.env.CORS_ORIGINS
    ...
    : ['https://roadtripeado.shop','http://localhost:3000', 'http://10.10.26.173:3000', 'http://10.10.26.172:3000', 'http://195.35.6.13:3008', 'http://localhost:3001', 'https://mohosin5004.binarybards.online'],
