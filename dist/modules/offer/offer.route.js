...
router
    .route('/')
    .post((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(offer_validation_1.createOfferZodSchema), offer_controller_1.OfferController.createOffer)
    .get(offer_controller_1.OfferController.getAllOffers);
router
    .route('/:id')
    .get(offer_controller_1.OfferController.getOfferById)
    .patch((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(offer_validation_1.updateOfferZodSchema), offer_controller_1.OfferController.updateOffer)
