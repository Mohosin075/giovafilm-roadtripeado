...
router.post('/faq', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(public_validation_1.FaqValidations.create), public_controller_1.PublicController.createFaq);
router.patch('/faq/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(public_validation_1.FaqValidations.update), public_controller_1.PublicController.updateFaq);
...
router.delete('/faq/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), public_controller_1.PublicController.deleteFaq);
