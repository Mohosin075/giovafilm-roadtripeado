...
router.post('/extract-coordinates', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.MAP_EDITOR, user_1.USER_ROLES.USER), place_controller_1.PlaceController.extractCoordinates);
router.post('/:id/view', place_controller_1.PlaceController.incrementOpenCount);
router
    .route('/:id')
    .get(place_controller_1.PlaceController.getPlaceById)
    .patch((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.MAP_EDITOR), (0, processReqBody_1.fileAndBodyProcessorUsingDiskStorage)(), (0, validateRequest_1.default)(place_validation_1.updatePlaceZodSchema), place_controller_1.PlaceController.updatePlace)
