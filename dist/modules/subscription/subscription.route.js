...
router.get('/verify-checkout', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(subscription_validation_1.subscriptionValidation.verifyCheckoutSession), subscription_controller_1.SubscriptionController.verifyCheckoutSession);
...
router.delete('/admin/plans/:planId', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(subscription_validation_1.subscriptionValidation.planParams), subscription_controller_1.SubscriptionController.deleteSubscriptionPlan);
