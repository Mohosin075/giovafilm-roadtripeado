                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px; text-align:center;">
                    ...
                    <div style="margin-bottom: 32px;">
                      <a href="${config_1.default.clientUrl}/otp-verify?email=${encodeURIComponent(values.email)}&authType=createAccount" style="display:inline-block; background-color:#FFC107; color:#000000; padding:16px 40px; border-radius:10px; text-decoration:none; font-weight:700; font-size:16px; box-shadow: 0 4px 6px rgba(255, 193, 7, 0.2);">Verify Now</a>
                    </div>
                  </td>
                </tr>
                <tr>
              ...
              <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 25px rgba(0,0,0,0.05); border: 1px solid #E5E7EB;">
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px; text-align:center;">
                    ...
                    <p style="color:#777777; font-size:14px; margin:0 0 32px;">This code expires in 5 minutes. If you did not request this, please ignore this email.</p>
                    <div style="margin-bottom: 32px;">
                      <a href="${config_1.default.clientUrl}/otp-verify?email=${encodeURIComponent(values.email)}&authType=resetPassword" style="display:inline-block; background-color:#FFC107; color:#000000; padding:16px 40px; border-radius:10px; text-decoration:none; font-weight:700; font-size:16px; box-shadow: 0 4px 6px rgba(255, 193, 7, 0.2);">Reset Password</a>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px; text-align:center;">
                    ...
                    <div style="margin-bottom: 8px;">
                      <a href="${config_1.default.clientUrl}/otp-verify?email=${encodeURIComponent(values.email)}&authType=${isReset ? 'resetPassword' : 'createAccount'}" style="display:inline-block; background-color:#FFC107; color:#000000; padding:16px 40px; border-radius:10px; text-decoration:none; font-weight:700; font-size:16px; box-shadow: 0 4px 6px rgba(255, 193, 7, 0.2);">${isReset ? 'Reset Password' : 'Verify Now'}</a>
                    </div>
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            ? `
                    <div style="background:#e8f4fd; padding:20px; border-radius:8px; margin-bottom:20px;">
                      ...
                      <p style="color:#555555; margin:0;">You have ${values.trialDays} days to explore all features. Your trial ends on ${(_a = values.trialEndDate) === null || _a === void 0 ? void 0 : _a.toLocaleDateString()}.</p>
                    </div>
                    `
            : ''}
              ...
              <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 25px rgba(0,0,0,0.05); border: 1px solid #E5E7EB;">
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px; text-align:center;">
                    ...
                    <!-- CTA Button -->
                    <div style="margin-bottom: 32px;">
                      <a href="${config_1.default.clientUrl}/otp-verify?email=${encodeURIComponent(values.email)}&authType=invite" target="_blank" style="display:inline-block; background-color:#FFC107; color:#000000; padding:16px 40px; border-radius:10px; text-decoration:none; font-weight:700; font-size:16px; box-shadow: 0 4px 6px rgba(255, 193, 7, 0.2); transition: all 0.3s ease;">
                        Accept Invitation
                      </a>
                    </div>
