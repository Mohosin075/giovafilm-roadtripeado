...
async function fetchGooglePlacePhotos(placeName, country, maxPhotos = 3) {
    ...
    try {
        ...
        const searchRes = await axios_1.default.get(`https://maps.googleapis.com/maps/api/place/textsearch/json`, {
            params: {
        ...
        const photos = (_a = detailsRes.data.result) === null || _a === void 0 ? void 0 : _a.photos;
...
async function fixPlaceImages() {
    ...
    const placesNeedingFix = allPlaces.filter((p) => needsFix(p.media));
